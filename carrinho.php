        ...
        <ul class="list-group mb-3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6 offset-6 col-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-x1-2 align-self-center mt-3">
                        ...
                        <div class="text-right mt-2">
                            <small class="text-secondary">Valor Unitário: R$10,00</small><br>
            ...
            <li class="list-group-item py-3">
                <div class="row g-3">
                    ...
                    <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                        <h4><b><a href="#" class="text-decoration-none text-dark"> Camisa para Personalização</a></b></h4>
                        <h5>
                            <small> Camisa Toda Branca para Personalização</small>
                        </h5>
                    </div>
                    <div class="col-6 offset-6 col-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-x1-2 align-self-center mt-3">
                        <div class="input-group">
                        ...
                        <div class="text-right mt-2">
                            <small class="text-secondary">Valor Unitário: R$30,00</small><br>
            ...
            <li class="list-group-item py-3">
                <div class="row g-3">
                    ...
                    <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                        ...
                        <h5>
                            <small> Tamanho:P; Cor:Preto; Composto por 50% algodão e 50% poliéster.</small>
                        </h5>
                    </div>
                    <div class="col-6 offset-6 col-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-x1-2 align-self-center mt-3">
                        <div class="input-group">
                        ...
                        <div class="text-right mt-2">
                            <small class="text-secondary">Valor Unitário: R$20,00</small><br>
